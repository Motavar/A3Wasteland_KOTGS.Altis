...
_handleCapPointTick = {
	...
	for "_i" from 0 to (_count - 1) do
	{
		...
		diag_log format["TERRITORY_NAME: %1", _currentTerritoryName];
		diag_log format["TERRITORY_Occupiers: %1", _currentTerritoryOccupiers];
		diag_log format["TERRITORY_Owner: %1", _currentTerritoryOwner];
		diag_log format["TERRITORY_Chrono: %1", _currentTerritoryChrono];
		diag_log format["TERRITORY_Timer: %1", _currentTerritoryTimer];
