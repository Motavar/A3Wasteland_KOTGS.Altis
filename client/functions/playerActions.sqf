...
[
	...
	["<t color='#00FF00'>Convince To Join Your Side (WEST)</t>", "client\functions\captureGunStore.sqf", [], 6, false, false, "", "_trgt = cursorTarget; _trgt distance _this <= 4 && (_trgt getVariable ['Side',''] =='WEST')"], 
	["<t color='#00FF00'>Convince To Join Your Side (EAST)</t>", "client\functions\captureGunStore.sqf", [], 6, false, false, "", "_trgt = cursorTarget; _trgt distance _this <= 4 && (_trgt getVariable ['Side',''] =='EAST')"], 
